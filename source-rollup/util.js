...
export function createTable (selector, fieldNames, data) {
...
export function extractData (table) {
...
export function rewriteData (table, data) {
...
export function extractFieldNames (table) {
return Array.from(table.querySelectorAll ("thead > tr > th"))
.map (cell => cell.textContent);
} // extractFieldNames

export function createUnorderedDataStore (data, fieldNames) {
return data.map (row => {
let object = {};
...
export function createOrderedData (store, fieldNames) {
