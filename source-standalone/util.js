...
(function (module) {
module.createTable = createTable;
...
module.rewriteData = rewriteData;
...
module.extractFieldNames = extractFieldNames;
function extractFieldNames (table) {
return Array.from(table.querySelectorAll ("thead > tr > th"))
.map (cell => cell.textContent);
} // extractFieldNames

module.createUnorderedDataStore = createUnorderedDataStore;
...
module.createOrderedData = createOrderedData;
